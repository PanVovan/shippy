...
import (
	...
	pb "github.com/PanVovan/shippy/shippy-service-consignment/proto/consignment"
...
func (s *consignmentService) GetConsignments(ctx context.Context, reg *pb.GetRequest, res *pb.Response) error {
